...
class GetModel(BaseApi):
    ...
    async def aget_model(
        ...
        args = self._get_model_mapped_args(
            model_id=model_id,
        )
        return await self._aget_model_oapg(
