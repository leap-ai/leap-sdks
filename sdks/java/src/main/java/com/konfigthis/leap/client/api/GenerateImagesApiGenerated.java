...
public class GenerateImagesApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public GenerateImagesApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public GenerateImagesApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createCall(String modelId, CreateInferenceDto createInferenceDto, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createValidateBeforeCall(String modelId, CreateInferenceDto createInferenceDto, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'modelId' is set
        if (modelId == null) {
            throw new ApiException("Missing the required parameter 'modelId' when calling create(Async)");
        }

        // verify the required parameter 'createInferenceDto' is set
        if (createInferenceDto == null) {
            throw new ApiException("Missing the required parameter 'createInferenceDto' when calling create(Async)");
        }

        return createCall(modelId, createInferenceDto, _callback);

    }


    private ApiResponse<InferenceEntity> createWithHttpInfo(String modelId, CreateInferenceDto createInferenceDto) throws ApiException {
        okhttp3.Call localVarCall = createValidateBeforeCall(modelId, createInferenceDto, null);
        Type localVarReturnType = new TypeToken<InferenceEntity>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createAsync(String modelId, CreateInferenceDto createInferenceDto, final ApiCallback<InferenceEntity> _callback) throws ApiException {

        okhttp3.Call localVarCall = createValidateBeforeCall(modelId, createInferenceDto, _callback);
        Type localVarReturnType = new TypeToken<InferenceEntity>(){}.getType();
    ...
    public class CreateRequestBuilder {
         ...
         */
        public CreateRequestBuilder negativePrompt(String negativePrompt) {
         ...
         * @return CreateRequestBuilder
         */
        public CreateRequestBuilder webhookUrl(String webhookUrl) {
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            ...
            <tr><td> 200 </td><td> Successfully submitted image generation job. </td><td>  -  </td></tr>
         </table>
         */
        ...
        public InferenceEntity execute() throws ApiException {
            CreateInferenceDto createInferenceDto = buildBodyParams();
            ApiResponse<InferenceEntity> localVarResp = createWithHttpInfo(modelId, createInferenceDto);
        ...
        public ApiResponse<InferenceEntity> executeWithHttpInfo() throws ApiException {
            CreateInferenceDto createInferenceDto = buildBodyParams();
            return createWithHttpInfo(modelId, createInferenceDto);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<InferenceEntity> _callback) throws ApiException {
            CreateInferenceDto createInferenceDto = buildBodyParams();
            return createAsync(modelId, createInferenceDto, _callback);
        }
    }
     ...
     */
    public CreateRequestBuilder create(String prompt, String modelId) throws IllegalArgumentException {
        ...
        return new CreateRequestBuilder(prompt, modelId);
    }
    private okhttp3.Call findAllCall(String modelId, Boolean onlyFinished, Double page, Double pageSize, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call findAllValidateBeforeCall(String modelId, Boolean onlyFinished, Double page, Double pageSize, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'modelId' is set
        if (modelId == null) {
            throw new ApiException("Missing the required parameter 'modelId' when calling findAll(Async)");
        }

        return findAllCall(modelId, onlyFinished, page, pageSize, _callback);

    }


    private ApiResponse<List<InferenceEntity>> findAllWithHttpInfo(String modelId, Boolean onlyFinished, Double page, Double pageSize) throws ApiException {
        okhttp3.Call localVarCall = findAllValidateBeforeCall(modelId, onlyFinished, page, pageSize, null);
        Type localVarReturnType = new TypeToken<List<InferenceEntity>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call findAllAsync(String modelId, Boolean onlyFinished, Double page, Double pageSize, final ApiCallback<List<InferenceEntity>> _callback) throws ApiException {

        okhttp3.Call localVarCall = findAllValidateBeforeCall(modelId, onlyFinished, page, pageSize, _callback);
        Type localVarReturnType = new TypeToken<List<InferenceEntity>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class FindAllRequestBuilder {
        private final String modelId;
        private Boolean onlyFinished;
        private Double page;
        private Double pageSize;

        private FindAllRequestBuilder(String modelId) {
            this.modelId = modelId;
        }
         ...
         * @return FindAllRequestBuilder
         */
        public FindAllRequestBuilder onlyFinished(Boolean onlyFinished) {
         ...
         * @return FindAllRequestBuilder
         */
        public FindAllRequestBuilder page(Double page) {
            this.page = page;
            return this;
        }
         ...
         * @return FindAllRequestBuilder
         */
        public FindAllRequestBuilder pageSize(Double pageSize) {
        ...
        public List<InferenceEntity> execute() throws ApiException {
            ApiResponse<List<InferenceEntity>> localVarResp = findAllWithHttpInfo(modelId, onlyFinished, page, pageSize);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute findAll request with HTTP info returned
        ...
        public ApiResponse<List<InferenceEntity>> executeWithHttpInfo() throws ApiException {
            return findAllWithHttpInfo(modelId, onlyFinished, page, pageSize);
        }

        /**
         * Execute findAll request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<List<InferenceEntity>> _callback) throws ApiException {
            return findAllAsync(modelId, onlyFinished, page, pageSize, _callback);
        }
    }
     ...
     */
    public FindAllRequestBuilder findAll(String modelId) throws IllegalArgumentException {
        if (modelId == null) throw new IllegalArgumentException("\"modelId\" is required but got null");
            

        return new FindAllRequestBuilder(modelId);
    }
    ...
    private okhttp3.Call removeCall(String modelId, String inferenceId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call removeValidateBeforeCall(String modelId, String inferenceId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'modelId' is set
        if (modelId == null) {
            throw new ApiException("Missing the required parameter 'modelId' when calling remove(Async)");
        }

        // verify the required parameter 'inferenceId' is set
        if (inferenceId == null) {
            throw new ApiException("Missing the required parameter 'inferenceId' when calling remove(Async)");
        }

        return removeCall(modelId, inferenceId, _callback);

    }


    private ApiResponse<Void> removeWithHttpInfo(String modelId, String inferenceId) throws ApiException {
        okhttp3.Call localVarCall = removeValidateBeforeCall(modelId, inferenceId, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call removeAsync(String modelId, String inferenceId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = removeValidateBeforeCall(modelId, inferenceId, _callback);
    ...
    public class RemoveRequestBuilder {
        ...
        private RemoveRequestBuilder(String modelId, String inferenceId) {
            this.modelId = modelId;
            this.inferenceId = inferenceId;
        }
        ...
        public void execute() throws ApiException {
            removeWithHttpInfo(modelId, inferenceId);
        }
        ...
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            return removeWithHttpInfo(modelId, inferenceId);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            return removeAsync(modelId, inferenceId, _callback);
        }
    }
     ...
     */
    public RemoveRequestBuilder remove(String modelId, String inferenceId) throws IllegalArgumentException {
        if (modelId == null) throw new IllegalArgumentException("\"modelId\" is required but got null");
        ...
        return new RemoveRequestBuilder(modelId, inferenceId);
    }
}
