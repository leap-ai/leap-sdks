...
import com.konfigthis.leap.client.auth.Authentication;
import com.konfigthis.leap.client.auth.HttpBasicAuth;
import com.konfigthis.leap.client.auth.HttpBearerAuth;
import com.konfigthis.leap.client.auth.ApiKeyAuth;
...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.tryleap.ai";
    ...
    private void init() {
        ...
        setUserAgent("Konfig/1.0.1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.tryleap.ai
     ...
     * @return a {@link com.konfigthis.leap.client.ApiClient} object
     */
     ...
     * @throws com.konfigthis.leap.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.konfigthis.leap.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.konfigthis.leap.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.konfigthis.leap.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.konfigthis.leap.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.konfigthis.leap.client.ApiException If fail to serialize the request body object
     */
     ...
     * @throws com.konfigthis.leap.client.ApiException If fails to update the parameters
     */
     ...
     * @throws com.konfigthis.leap.client.ApiException If fail to serialize the request body object into a string
     */
